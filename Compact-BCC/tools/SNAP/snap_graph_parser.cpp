 ...
 *   g++ -std=c++17 -O3 snap_graph_parser.cpp -o snap_graph_parser -Iecl_graphs
 *
 ******************************************************************************/
...
//---------------------------------------------------------------------
std::string output_path = "/home/graphwork/cs22s501/datasets/txt/generated_graphs/ecl_format/";
...
void create_csr(const std::vector<std::set<int>>& adjlist, std::vector<int>& vertices, std::vector<int>& edges) {
    /* 
...
void print_CSR(const std::vector<int>& vertices, const std::vector<int>& edges) {
